// 生命是什么 — Schrödinger "What is Life?" study notes styles
...
const styles = {
  cover: STYLE_COVER,
  physics_dark: STYLE_PHYSICS_DARK,
  biology_light: STYLE_BIOLOGY_LIGHT,
...
module.exports = {
  styles, getStyle,
  STYLE_COVER, STYLE_PHYSICS_DARK, STYLE_BIOLOGY_LIGHT, STYLE_OVERVIEW,
};
